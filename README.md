...
本指南提供 **[GPT使用](https://gpt.lanjing.pro)指南**，并**支持ChatGPT-4**，您可以**无限制地使用GPT-4、GPT-4o、o1**
...
1. **选择镜像站**：从推荐列表中选择一个站点，如**一下AI ([xsimplechat.com](https://xsimplechat.com/))** 或**蓝鲸AI ([gpt.lanjing.pro](https://gpt.lanjing.pro))** 。
